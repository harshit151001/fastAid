...
const Login = props => {
  ...
  console.log(props.location.state.seller);
        ...
        <div className="card-body">
          ...
          <div className="card-text">
            ...
            <form className="form-login">
              ...
              <div>
                <div>
                  <input value={!seller} onChange={() => setSeller(seller => !seller)} checked={!seller} type="checkbox" /> I am a Voulenteer
                </div>
                <div>
                  <input value={seller} onChange={() => setSeller(seller => !seller)} checked={seller} type="checkbox" /> I am a Seller
                </div>
              </div>
              <button
                onClick={() => {
